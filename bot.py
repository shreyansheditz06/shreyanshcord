...
raj = commands.Bot(description='SELFBOT',
                           command_prefix='.',
                           self_bot=True,
                           intents=intents)
status_task = None
